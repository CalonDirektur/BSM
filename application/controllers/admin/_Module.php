...
// $select_join .= ' $this->db->join("' .$one_to_many_table. '", "' . $table . '.' . $primary_key . ' = ' .
$one_to_many_table . '.' .$one_to_many_field. '", "left");
...
$foreign_tables .= '$data["' . $_POST[$value]["selected_table"] . '"]=$this->' . $table . '->getListTable("' .
$_POST[$value]["selected_table"] . '");';

$alias .= " , " . $_POST[$value]["selected_table"] . "." . $_POST[$value]["value"] . " as $value ";

$select_join .= ' $this->db->join("' . $_POST[$value]["selected_table"] . '", "' . $table . '.' . $value . ' = ' .
$_POST[$value]["selected_table"] . '.' . $_POST[$value]["key"] . '", "left"); ';
...
for ($i = 0; $i < count($_POST["multiselect"]["table"]); $i++) { if ($_POST["multiselect"]["table"][$i]) {
    $rtable=$_POST["multiselect"]["r_table"][$i]; $field1=$_POST["multiselect"]["r_main"][$i];
    $field2=$_POST["multiselect"]["r_multi"][$i]; $call_multi_add .="\n\t\t\t@@@this->==table==->multiSelectInsert(\"
    $rtable\", \"$field2\", @@@insert_id, \"$field1\", @@@_POST['" . $_POST["multiselect"]["table"][$i] . "']);\n" ;
    $call_multi_edit .="\n\t\t\t@@@this->==table==->multiSelectInsert(\" $rtable\", \"$field2\", @@@id, \"$field1\",
    @@@_POST['" . $_POST["multiselect"]["table"][$i] . "']);\n" ; $list_tbl .="\t@@@data['" .
    $_POST["multiselect"]["table"][$i] . "']=@@@this->==table==->getList('" . $_POST["multiselect"]["table"][$i]
    . "');\n" ; $return_multi_selected_id .="\n\t\t\t@@@data['selected_" . $_POST["multiselect"]["table"][$i]
    . "'] = @@@this->==table==->getSelectedIds(\" $rtable\", @@@id, \"$field1\", \"$field2\");\n"; $multi_selected_id
    .="\n\t\t\t@@@selected_" . $_POST["multiselect"]["table"][$i] . "_id = @@@this->==table==->getSelectedIds(\"
    $rtable\", @@@id, \"$field1\", \"$field2\");\n"; $return_multi_selected_data .="\n\t\t\t@@@data['selected_" .
    $_POST["multiselect"]["table"][$i] . "_data'] = array();

            if (isset(@@@selected_" . $_POST["multiselect"]["table"][$i] . "_id) && !empty(@@@selected_" .
    $_POST["multiselect"]["table"][$i] . "_id)) {

        \n\t\t\t\t@@@data['selected_" . $_POST["multiselect"]["table"][$i]
    . "_data'] = @@@this->==table==->getSelectedData('" . $_POST["multiselect"]["table"][$i] . "', '" .
    $_POST["multiselect"]["value"][$i] . "', @@@selected_" . $_POST["multiselect"]["table"][$i] . "_id);\n\t\t}\n" ; } }
    } /////////////////////////////////////////////////////////// //////////////////// Generate Validation End
    ////////////// /////////////////////////////////////////////////////////// $sort_fields_arr=implode(', ', $sort_fields_arr);

            $sort_fields_arr2 = implode(' , ', $sort_fields_arr2);

            $data = str_replace(' ***foreign_table***', $foreign_tables, $data); $data=str_replace("==validation==", $validations, $data);
            ...
            $data = str_replace(" {{status_field}}", $status_field, $data); $data=str_replace("++sort_fields_arr++",
    $sort_fields_arr, $data); $data=str_replace("++sort_fields_arr2++", $sort_fields_arr2, $data);
    $data=str_replace("==list_tbl==", $list_tbl, $data);

            $data = str_replace("==table==", $table, $data);

            $data = str_replace(" controller_name", ucfirst($table), $data); $data=str_replace("==primary_key==", $primary_key, $data);

            $data = str_replace(" @@@", "$" , $data); $status_field_string=implode(", ", $status_arr);
...
//////////////////////////////////////////////////////////////////////////
            ...
            $model_path = $this->config->item('base_path') . " application/models/admin/"; $file=$model_path .
    ucfirst($table) . '_model.php' ; $handle=fopen($file, 'w' ) or die('Cannot open file: ' . $file);
    ...
    $current=fread($myfile, filesize($exist_model_path . "module_files/model.php" )); fclose($myfile); /// Write the
    //contents back to the file ; file_put_contents($file, $current); $data=file_get_contents($file);
    file_put_contents($file, $current); $data=file_get_contents($file); $current=str_replace("@@@", "$" , $data);
    $current=str_replace("++sort_fields_arr++", $sort_fields_arr, $current); $current=str_replace("==table==", ucfirst($table), $current);
...
//////////////////////////////////////////////////////////////////////////
            ...
            $ori_path = $this->config->item('base_path') . " application/views/admin/"; $view_path=$this->
    config->item('base_path') . "application/views/admin/$table/";
    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">
            ...
            <input type="text" class="form-control span2 datepicker" id="' . $value . '" name="' . $value . '"
                value="<?php echo set_value("' . $value . '","' . date('Y-m-d') . '"); ?>">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">
            ...
            <textarea class="form-control" id="' . $value . '"
                name="' . $value . '"><?php echo set_value("' . $value . '"); ?></textarea>
    ...
    <div class="form-group">
        ...
        <div class=" col-md-4 switch">
            ...
            <div class="onoffswitch">
                ...
                <input type="checkbox" class="onoffswitch-checkbox" checked data-on-label="Yes" data-off-label="No"
                    name="' . $value . '" value="1" id="' . $value . '"
                    <?php echo set_checkbox("' . $value . '","1")?> />
    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">';
            ...
            for ($aaa = 0; $aaa < count($rad_arr); $aaa++) { $formfields .='

            <span style="margin-right:20px;"><input type="radio" style="width:20px; height:20px;" name="' . $value
                . '" value="' . $rad_arr[$aaa] . '"> ' . $rad_arr[$aaa] . ' </span>' ; } $formfields .='
...
' ; } //////////////////////////////////////////////////// /////// ./ GENERATE RADIO FIELD FOR ADD /. /////////
 ...
 <div class="form-group">
          ...
          <div class="col-sm-4">' ; $rad_arr=$_POST[$value]['checks']; for ($aaa=0; $aaa < count($rad_arr); $aaa++) {
                $formfields .='

            <span style="margin-right:20px;"><input type="checkbox" style="width:20px; height:20px;" name="' . $value
                . '[]" value="' . $rad_arr[$aaa] . '"> ' . $rad_arr[$aaa] . ' </span>' ; } $formfields .='
...
' ; } //////////////////////////////////////////////////// /////////// GENERATE CHECKBOX FIELD FOR ADD ////////
    ...
    ' ; } //////////////////////////////////////////////////// /////////// ./ GENERATE IMAGE FIELD FOR ADD /. /////
                //////////////////////////////////////////////////// } } if (isset($_POST["multiselect"])) { for ($i=0;
                $i < count($_POST["multiselect"]["table"]); $i++) { ////////////////////////////////////////////////////
                ////////// GENERATE MULTI SELECT FIELD FOR ADD ///////////
                //////////////////////////////////////////////////// if ($_POST["multiselect"]["table"][$i]) {
                $value=$_POST["multiselect"]["table"][$i]; $formfields .='
...
' ; } //////////////////////////////////////////////////// ///////// ./ GENERATE MULTI SELECT FIELD FOR ADD /. //////
            ...
            $data = str_replace(" singlequote", "'" , $data); file_put_contents($add_file, $data);
                ////////////////////////////////////////////////////////////////////////// ///////////////////////////
                ...
                ////////////////////////////////////////////////////////////////////////// $ori_path=$this->
                config->item('base_path') . "application/views/admin/";
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        ...
                        <textarea class="form-control" id="' . $value . '"
                            name="' . $value . '"><?php echo set_value("' . $value . '",html_entity_decode($' . $table . '->' . $value . ')); ?></textarea>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        ...
                        <input type="text" class="form-control span2 datepicker" id="' . $value . '"
                            name="' . $value . '"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        ...
                        <input type="text" class="form-control datetimepicker" name="' . $value . '" id="' . $value . '"
                            value="<?php echo set_value("' . $value . '",$' . $table . '->' . $value . '); ?>" />
      ...
      foreach($' . $_POST[$value]['selected_table'] . ' as $key => $value): ?>
                            ...
                            <option value="<?php echo $value->' . $_POST[$value]['key'] . '; ?>"
                                <?php echo $value->' . $_POST[$value]['key'] . '==$' . $table . '->' . $value . '?\'selected="selected"\':""; ?>>
                ...
                <div class="form-group">
                    ...
                    <div class=" col-md-4 switch">
                        ...
                        <div class="onoffswitch">
                            ...
                            <input type="checkbox" class="onoffswitch-checkbox" data-on-label="Yes" data-off-label="No"
                                name="' . $value . '" value="1" id="' . $value . '"
                                <?php if(set_value("' . $value . '",$' . $table . '->' . $value . ' == 1)){echo "checked=checked";}?> />
	            ...
	            <span style="margin-right:20px;"><input type="radio" style="width:20px; height:20px;" <?php echo $' . $table . '->' . $value . '=="' . $rad_arr[$aaa] . '"?\'checked="checked"\':""; ?> name="'
                            . $value . '" value="' . $rad_arr[$aaa] . '"> ' . $rad_arr[$aaa] . ' </span>' ; }
                            $formfields .='
	...
	' ; } //////////////////////////////////////////////////// ////// ./ GENERATE Edit Status FIELD FOR ADD /. ////
                            ////////////////////////////////////////////////////
                            //////////////////////////////////////////////////// ///////// GENERATE Edit Checkbox FIELD
                            FOR ADD ///// //////////////////////////////////////////////////// elseif
                            ($_POST[$value][0]=="checkbox" ) { $formfields .='
		...
		' ; $rad_arr=$_POST[$value]['checks']; for ($aaa=0; $aaa < count($rad_arr); $aaa++) { $formfields
                            .='

			<span style="margin-right:20px;"><input type="checkbox" style="width:20px; height:20px;" <?php echo in_array("' . $rad_arr[$aaa] . '", $arr)?\'checked="checked"\':""; ?> name="' . $value
                            . '[]" value="' . $rad_arr[$aaa] . '"> ' . $rad_arr[$aaa] . ' </span>' ; } $formfields .='
	...
	' ; } //////////////////////////////////////////////////// //// ./ GENERATE Edit Checkbox FIELD FOR ADD /. ////
                            ////////////////////////////////////////////////////
                            //////////////////////////////////////////////////// ///////// GENERATE Edit Image FIELD FOR
                            ADD //////// //////////////////////////////////////////////////// elseif
                            ($_POST[$value][0]=="image" ) { $formfields .='
  ...
  <img src="<?php echo $this->config->item("photo_url");?><?php echo $' . $table . '->' . $value . '; ?>" alt="pic" width="50" height="50" />
    ...
    ' ; } //////////////////////////////////////////////////// ///// ./ GENERATE Edit Image FIELD FOR ADD /. //////
                            ...
                            FOR EDIT ///// //////////////////////////////////////////////////// if
                            ($_POST["multiselect"]["table"][$i]) { $value=$_POST["multiselect"]["table"][$i];
                            $formfields .='
...
' ; } //////////////////////////////////////////////////// ////// ./ GENERATE MULTI SELECT FIELD FOR EDIT /. ///
            ...
            $data = str_replace(" singlequote", "'" , $data); file_put_contents($edit_file, $data);
                            //////////////////////////////////////////////////////////////////////////
                            ...
                            $myfile = fopen($controller_path . "module_files/view.php", "r") or die("Unable to open
                            file!");
                            ...
                            <table class='table table-bordered' style='width:70%;' align='center'>";
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <label for="' . $value . '" class="col-sm-3 control-label"> ' . ucfirst($value)
                                            . ' </label>
                                ...
                                elseif ($_POST[$value][0] == "date" || $_POST[$value][0] == "time" || $_POST[$value][0]
                                == "datetime") {
	 ...
	 <td>
	   ...
	   <?php $arr=explode(", ", $' . $table . '->' . $value . ') ?>
	          ...
	          ' ; $rad_arr=$_POST[$value]['checks']; for ($aaa=0; $aaa < count($rad_arr); $aaa++) { $formfields
	            ...
	            <span style="margin-left:5px;"><?php echo in_array("' . $rad_arr[$aaa] . '", $arr)?\'' . $rad_arr[$aaa] . ', \':""; ?></span>' ; } $formfields .='
	...
	' ; } //////////////////////////////////////////////////// ///// ./ GENERATE Edit Image FIELD FOR ADD /. //////
                                            //////////////////////////////////////////////////// } } if
                                            (isset($_POST["multiselect"])) { for ($i=0; $i <
                                            count($_POST["multiselect"]["table"]); $i++) { if
                                            ($_POST["multiselect"]["table"][$i]) {
                                            $rtable=$_POST["multiselect"]["r_table"][$i];
                                            $field1=$_POST["multiselect"]["r_main"][$i];
                                            $field2=$_POST["multiselect"]["r_multi"][$i]; $call_multi_add
                                            .="\n\t@@@this->==table==->multiSelectInsert(\" $rtable\", \"$field2\",
                                            @@@insert_id, \"$field1\", @@@_POST['" . $_POST["multiselect"]["table"][$i]
                                            . "']);\n" ; $call_multi_edit
                                            .="\n\t@@@this->==table==->multiSelectInsert(\" $rtable\", \"$field2\",
                                            @@@id, \"$field1\", @@@_POST['" . $_POST["multiselect"]["table"][$i]
                                            . "']);\n" ; $list_tbl .="\n\t@@@data['" .
                                            $_POST["multiselect"]["table"][$i] . "']=@@@this->==table==->getList('" .
                                            $_POST["multiselect"]["table"][$i] . "');\n" ; $return_multi_selected_id
                                            .="\n\t@@@data['selected_" . $_POST["multiselect"]["table"][$i]
                                            . "'] = @@@this->==table==->getSelectedIds(\" $rtable\", @@@id, \"$field1\",
                                            \"$field2\");\n"; $formfields .='
            ...
            $data = str_replace(" singlequote", "'" , $data); // $data=str_replace("==backscript==", "", $data);
...
//////////////////////////////////////////////////////////////////////////
            ...
            $ori_path = $this->config->item('base_path') . " application/views/admin/"; $view_path=$this->
                                            ...
                                            $handle = fopen($manage_file, 'w') or die('Cannot open file: ' .
                                            $manage_file);
                                            ...
                                            $myfile = fopen($controller_path . "module_files/manage.php", "r") or
                                            die("Unable to open file!");

                                            $current = fread($myfile, filesize($controller_path .
                                            "module_files/manage.php"));
                                    ...
                                    <th><input name='input' id='del' onclick=\"callme('show')\" type='checkbox'
                                            class='del' value='<?php echo @@@value->" . $primary_key . "; ?>' /></th>



                                    <th><?php if(!empty(@@@value->" . $primary_key . ")){ echo @@@count; @@@count++; }?>
                                    </th>";
				 ...
				 $symbol = isset($_GET["sortBy"]) && $_GET["sortBy"]=="' . $_POST[$value]["selected_table"] . '.' . $_POST[$value]["value"] . '"?"<i class=\'fa fa-sort-$sortSym\' aria-hidden=\'true\'></i>": "<i class=\'fa fa-sort\' aria-hidden=\'true\'></i>"; ?>
                                    ...
                                    <th> <a href="<?php echo $fields_links["' . $_POST[$value]["selected_table"] . '.' . $_POST[$value]["value"] . '"]; ?>"
                                            class="link_css"> ' . ucfirst($value) . ' <?php echo $symbol ?></a></th>

                                    ';

                                    $option_fields .= '<option value="' . $_POST[$value][" selected_table"] . '.' .
                                        $_POST[$value]["value"]
                                        . '" <?php echo $searchBy=="' . $_POST[$value]["selected_table"] . '.' . $_POST[$value]["value"] . '"?\'selected="selected"\':""; ?>>'
                                        . ucfirst($value) . '</option>' ; } else { $tableheadrows .='
				...
				<th> <a href="<?php echo $fields_links["' . $value . '"]; ?>" class="link_css"> ' . ucfirst($value) . ' <?php echo $symbol ?></a></th>
						...
						' ; $option_fields .='<option value="' . $value
                                        . '" <?php echo $searchBy=="' . $value . '"?\'selected="selected"\':""; ?>>' .
                                        ucfirst($value) . '</option>' ; } if ($_POST[$value][0]=='status' ) {
                                        $tabledatarows .='<th><a href="<?php echo base_url()?>admin/' . $table
                                        . '/status/' . $value . '/<?php echo @@@value->' . $primary_key . '."?redirect=".current_url()."?".urlencode($_SERVER["QUERY_STRING"]); ?>">
                ...
                ' ; } elseif ($_POST[$value][0]=='image' ) { $tabledatarows .='<th><?php if(!empty(@@@value->' . $value . ')){ ?>

                        <img src="<?php echo $this->config->item(\'photo_url\');?><?php echo @@@value->' . $value . '; ?>" alt="pic" width="50" height="50" />

                         <?php }?></th>' ; } else { $tabledatarows .='<th><?php if(!empty(@@@value->' . $value . ')){ echo @@@value->' . $value . '; }?></th>
                ...
                ' ; } } //echo $_POST[$value][0]."<br>";
                                        ...
                                        $tabledatarows .= '<th class="action-width">
                                            ...
                                            <a href="<?php echo base_url()?>admin/' . $one_to_many_table . '/index/' . $one_to_many_field . '/<?php echo @@@value->' . $primary_key . '; ?>/1"
                                                title="View">
                                        ...
                                        $tabledatarows .= '<th class="action-width">
                                            ...
                                            <a href="<?php echo base_url()?>admin/' . $table_new . '/view/<?php echo @@@value->' . $primary_key . '; ?>"
                                                title="View">
                                            ...
                                            <a href="<?php echo base_url()?>admin/' . $table_new . '/edit/<?php echo @@@value->' . $primary_key . '; ?>"
                                                title="Edit">
                                            ...
                                            <a title="Delete" data-toggle="modal" data-target="#commonDelete"
                                                onclick="set_common_delete(\'<?php echo @@@value->' . $primary_key . '; ?>\',\'' . $table_new . '\');">
                                        ...
                                        $this->form_validation->set_rules('module_name', 'module Name',
                                        'trim|xss_clean');
                                        ...
                                        <li <?php if($contr == \'module\'){?>class="active " <?php } ?>>
                                            ...
                                            <a href="javascript:;"><i class="fa fa-users"></i><span
                                                    class="title">Module</span>

                                                <?php if($contr == \'module\'){?><span
                                                    class="selected"></span><?php } ?>

                                                <span
                                                    class="arrow <?php if($contr == \'module\'){?>open<?php } ?>"></span>
                                            ...
                                            <ul class="nav nav-second-level">
                                                ...
                                                <li <?php if($contrnew == \'module/add\'){?>class="active " <?php } ?>>
                                                    ...
                                                    <a href="<?php echo base_url()?>admin/module/add"><i
                                                ...
                                                <li <?php if($contrnew == \'module/\'){?>class="active" <?php } ?>>
                                                    ...
                                                    <a href="<?php echo base_url()?>admin/module/index"><i
                                                            class="fa fa-gear"></i>Manage Module</a>
                                        ...
                                        $controller_path = $this->config->item('base_path') .
                                        ...
                                        $myfile = fopen($controller_path . "module_files/controller_one_to_many.php",
                                        "r") or die("Unable to open file!");

                                        $current = fread($myfile, filesize($controller_path .
                                        "module_files/controller_one_to_many.php"));
                                        ...
                                        $foreign_tables .= '$data["' . $_POST[$value]["selected_table"] . '"]=$this->' .
                                        $table . '->getListTable("' . $_POST[$value]["selected_table"] . '");';

                                        $alias .= " , " . $_POST[$value]["selected_table"] . "." .
                                        $_POST[$value]["value"] . " as $value ";

                                        $select_join .= ' $this->db->join("' . $_POST[$value]["selected_table"] . '", "'
                                        . $table . '.' . $value . ' = ' . $_POST[$value]["selected_table"] . '.' .
                                        $_POST[$value]["key"] . '", "left"); ';

                                        $sort_fields_arr[] = "'" . $_POST[$value]["selected_table"] . "." .
                                        $_POST[$value]["value"] . "'";
                                        ...
                                        $validations .= "@@@this->form_validation->set_rules('$value', '$cap_field
                                        Name', 'trim|xss_clean');";
                                        ...
                                        $validations .= '$this->form_validation->set_rules("' . $value . '", "' .
                                        ucfirst($value) . '", "trim|xss_clean");

                                        $this->' . $table . '->uploadData($photo_data, "' . $value . '",
                                        "photo_path","","gif|jpg|png|jpeg");
                                        ...
                                        $this->form_validation->set_rules("' . $value . '","' . ucfirst($value) . '","'
                                        . $vals_str . '");

                                        }';

                                        $fields .= 'if(isset($photo_data["' . $value . '"]) && !empty($photo_data["' .
                                        $value . '"]))
                                        ...
                                        $fields .= "\t\t@@@saveData['$value'] = addslashes(implode(', ',
                                        \$_POST['$value']));\n";
                                        ...
                                        for ($i = 0; $i < count($_POST["multiselect"]["table"]); $i++) { if
                                            ($_POST["multiselect"]["table"][$i]) {
                                            $rtable=$_POST["multiselect"]["r_table"][$i];
                                            $field1=$_POST["multiselect"]["r_main"][$i];
                                            $field2=$_POST["multiselect"]["r_multi"][$i]; $call_multi_add
                                            ...
                                            .="\n\t\t\t@@@this->==table==->multiSelectInsert(\" $rtable\", \"$field2\",
                                            @@@id, \"$field1\", @@@_POST['" . $_POST["multiselect"]["table"][$i]
                                            . "']);\n" ; $list_tbl .="\t@@@data['" . $_POST["multiselect"]["table"][$i]
                                            . "']=@@@this->==table==->getList('" . $_POST["multiselect"]["table"][$i]
                                            . "');\n" ; $return_multi_selected_id .="\n\t\t\t@@@data['selected_" .
                                            $_POST["multiselect"]["table"][$i]
                                            . "'] = @@@this->==table==->getSelectedIds(\" $rtable\", @@@id, \"$field1\",
                                            \"$field2\");\n"; $multi_selected_id .="\n\t\t\t@@@selected_" .
                                            $_POST["multiselect"]["table"][$i]
                                            . "_id = @@@this->==table==->getSelectedIds(\" $rtable\", @@@id,
                                            \"$field1\", \"$field2\");\n"; $return_multi_selected_data
        ...
        \n\t\t\t\t@@@data['selected_" . $_POST["multiselect"]["table"][$i]
                                            . "_data'] = @@@this->==table==->getSelectedData('" .
                                            $_POST["multiselect"]["table"][$i] . "', '" .
                                            $_POST["multiselect"]["value"][$i] . "', @@@selected_" .
                                            $_POST["multiselect"]["table"][$i] . "_id);\n\t\t}\n" ; } } }
                                            ///////////////////////////////////////////////////////////
                                            //////////////////// Generate Validation End //////////////
                                            ///////////////////////////////////////////////////////////
            ...
            $data = str_replace(" {{status_field}}", $status_field, $data); $data=str_replace("++sort_fields_arr++",
                                            $sort_fields_arr, $data); $data=str_replace("++sort_fields_arr2++",
                                            $sort_fields_arr2, $data); $data=str_replace("==list_tbl==", $list_tbl, $data);
...
//////////////////////////////////////////////////////////////////////////
            ...
            $model_path = $this->config->item('base_path') . " application/models/admin/"; $file=$model_path .
                                            ucfirst($table) . '_model.php' ; $handle=fopen($file, 'w' ) or die('Cannot
                                            open file: ' . $file);

            $current = "";

            $exist_model_path = $this->config->item(' base_path') . "application/controllers/admin/" ;
                                            $myfile=fopen($exist_model_path . "module_files/model_one_to_many.php" , "r"
                                            ) or die("Unable to open file!"); $current=fread($myfile,
                                            filesize($exist_model_path . "module_files/model_one_to_many.php" ));
                                            fclose($myfile); // Write the contents back to the file
                                            file_put_contents($file, $current); $data=file_get_contents($file);
...
//////////////////////////////////////////////////////////////////////////
            ...
            $ori_path = $this->config->item('base_path') . " application/views/admin/"; $view_path=$this->
                                            ...
                                            $myfile = fopen($controller_path . "module_files/add_one_to_many.php", "r")
                                            or die("Unable to open file!");

                                            $current = fread($myfile, filesize($controller_path .
                                            "module_files/add_one_to_many.php"));
      ...
      foreach($' . $_POST[$value]['selected_table'] . ' as $key => $value): ?>
                                                        ...
                                                        <option
                                                            value="<?php echo $value->' . $_POST[$value]['key'] . '; ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label class="col-sm-3 control-label">Select ' . ucfirst($value) .
                                                    '</label>
...
' ; } //////////////////////////////////////////////////// /////////// GENERATE CHECKBOX FIELD FOR ADD ////////
    ...
    ' ; } //////////////////////////////////////////////////// /////////// ./ GENERATE IMAGE FIELD FOR ADD /. /////
                                                        //////////////////////////////////////////////////// } } if
                                                        (isset($_POST["multiselect"])) { for ($i=0; $i <
                                                        count($_POST["multiselect"]["table"]); $i++) {
                                                        //////////////////////////////////////////////////// //////////
                                                        GENERATE MULTI SELECT FIELD FOR ADD ///////////
                                                        //////////////////////////////////////////////////// if
                                                        ($_POST["multiselect"]["table"][$i]) {
...
' ; } //////////////////////////////////////////////////// ///////// ./ GENERATE MULTI SELECT FIELD FOR ADD /. //////
            ...
            $data = str_replace(" singlequote", "'" , $data); file_put_contents($add_file, $data);
                                                        ...
                                                        ////////////////////
                                                        //////////////////////////////////////////////////////////////////////////
                                                        $ori_path=$this->config->item('base_path') .
                                                        "application/views/admin/";

                                                        $view_path = $this->config->item('base_path') .
                                                        "application/views/admin/$table/";

                                                        $edit_file = $view_path . 'edit.php';

                                                        if (file_exists($edit_file)) {

                                                        $handle = fopen($edit_file, 'w') or die('Cannot open file: ' .
                                                        $edit_file);
                                                        ...
                                                        $myfile = fopen($controller_path . "module_files/edit.php", "r")
                                                        or die("Unable to open file!");

                                                        $current = fread($myfile, filesize($controller_path .
                                                        "module_files/add.php"));
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-4">
                                                                ...
                                                                <select class="form-control select2"
                                                                    ...
                                                                    <option value="">Select ' . ucfirst($value) . '
                                                                    </option>
      ...
      foreach($' . $_POST[$value]['selected_table'] . ' as $key => $value): ?>
                ...
                <span style="margin-right:20px;"><input type="radio" style="width:20px; height:20px;" <?php echo $' . $table . '->' . $value . '=="' . $rad_arr[$aaa] . '"?\'checked="checked"\':""; ?> name="'
                                                                    . $value . '" value="' . $rad_arr[$aaa] . '"> ' .
                                                                    $rad_arr[$aaa] . ' </span>' ; } $formfields .='
    ...
    ' ; } //////////////////////////////////////////////////// ////// ./ GENERATE Edit Status FIELD FOR ADD /. ////
        ...
        ' ; $rad_arr=$_POST[$value]['checks']; for ($aaa=0; $aaa < count($rad_arr); $aaa++) { $formfields
            ...
            <span style="margin-right:20px;"><input type="checkbox" style="width:20px; height:20px;" <?php echo in_array("' . $rad_arr[$aaa] . '", $arr)?\'checked="checked"\':""; ?> name="'
                                                                    . $value . '[]" value="' . $rad_arr[$aaa] . '"> ' .
                                                                    $rad_arr[$aaa] . ' </span>' ; } $formfields .='
    ...
    ' ; } //////////////////////////////////////////////////// //// ./ GENERATE Edit Checkbox FIELD FOR ADD /. ////
                                                                    ...
                                                                    ///////// GENERATE Edit Image FIELD FOR ADD ////////
                                                                    ////////////////////////////////////////////////////
                                                                    elseif ($_POST[$value][0]=="image" ) { $formfields
                                                                    .='
...
' ; } //////////////////////////////////////////////////// ////// ./ GENERATE MULTI SELECT FIELD FOR EDIT /. ///
            ...
            $data = str_replace(" singlequote", "'" , $data); file_put_contents($edit_file, $data);
                                                                    ...
                                                                    $handle = fopen($edit_file, 'w') or die('Cannot open
                                                                    file: ' . $edit_file);
                                                                    ...
                                                                    $myfile = fopen($controller_path .
                                                                    "module_files/view.php", "r") or die("Unable to open
                                                                    file!");
                                                                    ...
                                                                    <table class='table table-bordered'
                                                                        ...
                                                                        elseif ($_POST[$value][0] == "date" ||
                                                                        $_POST[$value][0] == "time" || $_POST[$value][0]
                                                                        == "datetime") {
           ...
           endforeach;
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                <label
                                                                                    class="col-sm-3 control-label">Select
                                                                                    ' . ucfirst($value) . '</label>
    ...
    ' ; } //////////////////////////////////////////////////// ///// ./ GENERATE Edit Image FIELD FOR ADD /. //////
                                                                                    ...
                                                                                    (isset($_POST["multiselect"])) { for
                                                                                    ($i=0; $i <
                                                                                    count($_POST["multiselect"]["table"]);
                                                                                    $i++) { if
                                                                                    ($_POST["multiselect"]["table"][$i])
                                                                                    {
                                                                                    $rtable=$_POST["multiselect"]["r_table"][$i];
...
//////////////////////////////////////////////////////////////////////////
            ...
            $ori_path = $this->config->item('base_path') . " application/views/admin/"; $view_path=$this->
                                                                                    config->item('base_path') .
                                                                                    "application/views/admin/$table/";

                                                                                    $manage_file = $view_path .
                                                                                    'manage.php';

                                                                                    if (file_exists($manage_file)) {

                                                                                    $handle = fopen($manage_file, 'w')
                                                                                    ...
                                                                                    $myfile = fopen($controller_path .
                                                                                    "module_files/manage_one_to_many.php",
                                                                                    "r") or die("Unable to open file!");

                                                                                    $current = fread($myfile,
                                                                                    filesize($controller_path .
                                                                                    "module_files/manage_one_to_many.php"));

                                                                                    fclose($myfile);

                                                                                    file_put_contents($manage_file,
                                                                                    $current);

                                                                                    $data =
                                                                                    file_get_contents($manage_file);

                                                                                    $data = str_replace("@@@", "$",
                                                                                    $data);

                                                                                    $data = str_replace("cntlr", $cntlr,
                                                                                    $data);
                                                                                    ...
                                                                                    $tabledatarows = "
                                                                            <th><input name='input' id='del'
                                                                                    onclick=\"callme('show')\"
                                                                                    type='checkbox' class='del'
                 ...
                 $symbol = isset($_GET["sortBy"]) && $_GET["sortBy"]=="' . $_POST[$value]["selected_table"] . '.' . $_POST[$value]["value"] . '"?"<i class=\'fa fa-sort-$sortSym\' aria-hidden=\'true\'></i>": "<i class=\'fa fa-sort\' aria-hidden=\'true\'></i>"; ?>
                                                                            ...
                                                                            <th> <a href="<?php echo $fields_links["' . $_POST[$value]["selected_table"] . '.' . $_POST[$value]["value"] . '"]; ?>"
                                                                                    class="link_css"> ' .
                                                                                    ucfirst($value) . '
                                                                                    <?php echo $symbol ?></a></th>

                                                                            ';

                                                                            $option_fields .= '
                                    <option value="' . $_POST[$value][" selected_table"] . '.' . $_POST[$value]["value"]
                                        . '" <?php echo $searchBy=="' . $_POST[$value]["selected_table"] . '.' . $_POST[$value]["value"] . '"?\'selected="selected"\':""; ?>>'
                                        . ucfirst($value) . '</option>' ; } else { $tableheadrows .='
                ...
                ' ; } } //echo $_POST[$value][0]."<br>";
                                        ...
                                        $tabledatarows .= '<th class="action-width">
                                            ...
                                            <a href="<?php echo base_url()?>admin/' . $table_new . '/view/<?php echo @@@value->' . $primary_key . '; ?>/<?php echo @@@rel_field; ?>/<?php echo @@@rel_id; ?>"
                                                title="View">
                                            ...
                                            <a href="<?php echo base_url()?>admin/' . $table_new . '/edit/<?php echo @@@value->' . $primary_key . '; ?>/<?php echo @@@rel_field; ?>/<?php echo @@@rel_id; ?>"
                                                title="Edit">
                                        ...
                                        $this->form_validation->set_rules('module_value', 'module Value',
                                        'trim|xss_clean|required');
                                        ...
                                        $data['module'] = $this->generic->getList('module', 'r', '', '', 'id', $id,
                                        'userid', $userid);
                                        ...
                                        if (!is_null($module = $this->generic->getList('module', 'r', '', '', 'id',
                                        $id))) {
                                        ...
                                        echo "<table
                                            class='table table-striped table-bordered table-hover client dataTable no-footer'
                                            cellpadding='20px' cellspacing='10px'>

                                            <tr>

                                                <td><input type='checkbox' onclick='checkAllCheckbox();' id='checkAll'>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td><input class="checked" type="checkbox" name="ischeck[]"
                                                ...
                                                <td>
                                                    ...
                                                    <select multiple chosen class="form-control chosen-select"
                                                        name="required_<?php echo $value; ?>[]"
                                                        id="required_<?php echo $value; ?>[]" style="width: 150px;">
                                                ...
                                                <td><input type="radio" class="default_input" value="input"
                                                        name="<?php echo $value; ?>[]"
                                                        onclick="setTitle('<?php echo $value; ?>');close_all();"></td>



                                                <!-- TEXTAREA -->

                                                <td><input type="radio" value="textarea" name="<?php echo $value; ?>[]"
                                                        onclick="setTitle('<?php echo $value; ?>');close_all();"></td>
                                                ...
                                                <td>
                                                    ...
                                                    <input type="radio" name="<?php echo $value; ?>[]" value="select"
                                                        onclick="show_tables('table_id_<?php echo $i; ?>');setTitle('<?php echo $value; ?>');">



                                                    <!-- select table for dropdown -->

                                                    <span class="top-display" id="table_id_<?php echo $i; ?>"
                                                        style="display: none">

                                                        Table: <select class="form-control"
                                                            id="select_table_<?php echo $i; ?>"
                                                            name="<?php echo $value . "[selected_table]"; ?>"
                                                            onchange="show_key_value('select_table_<?php echo $i; ?>', 'table_key_id_<?php echo $i; ?>', 'table_value_id_<?php echo $i; ?>', '<?php echo $value; ?>', '<?php echo $i; ?>');">
            ...
            for ($j = 0; $j < count($tables); $j++) {
                ...
                if (!in_array($tables[$j], array())) {
                    ...
                    ?>
                                                            ...
                                                            <option
                                                                value="<?php echo set_value('table_name', $tables[$j]); ?>">
                                                                <?php echo $tables[$j] ?></option>
                                                        ...
                                                        <span id="table_value_id_<?php echo $i; ?>"
                                                            style="display: none">
                                                ...
                                                <td><input type="radio" value="status" name="<?php echo $value; ?>[]"
                                                        onclick="setTitle('<?php echo $value; ?>');"></td>



                                                <!-- IMAGE -->

                                                <td><input type="radio" value="image" name="<?php echo $value; ?>[]"
                                                        onclick="setTitle('<?php echo $value; ?>');"></td>
                                                ...
                                                <td>
                                                    ...
                                                    <input type="radio" value="radio" name="<?php echo $value; ?>[]"
                                                        onclick="select_radio('radio_span_<?php echo $i; ?>', '<?php echo $i; ?>');

                            setTitle('<?php echo $value; ?>');">

                                                    <table class="top-display" id="radio_span_<?php echo $i; ?>"
                                                        style="display: none;">

                                                        <tr>
                                                            <td colspan="2"><a href="javascript:void(0)" onclick="setTitleRadio('<?php echo $value; ?>');

                                add_more_radio('radio_span_<?php echo $i; ?>');"><b>Add</b></a></td>
                                                        </tr>

                                                        <tr>

                                                            <td><input type="text" value="Radio"
                                                                    name="<?php echo $value; ?>[radios][]"></td>
                                                ...
                                                <td><input type="radio" value="checkbox" name="<?php echo $value; ?>[]"
                                                        onclick="select_check('check_span_<?php echo $i; ?>', '<?php echo $i; ?>');

                           ">

                                                    <table class="top-display" id="check_span_<?php echo $i; ?>"
                                                        style="display: none;">

                                                        <tr>
                                                            <td colspan="2"><a href="javascript:void(0)"
                                                                    onclick="setTitleCheck('<?php echo $value; ?>');add_more_check('check_span_<?php echo $i; ?>');"><b>Add</b></a>
                                                            </td>
                                                        </tr>

                                                        <tr>

                                                            <td><input value="Checkbox" type="text"
                                                                    name="<?php echo $value; ?>[checks][]"></td>
                                                ...
                                                <td><input type="radio" value="date" name="<?php echo $value; ?>[]"
                                                        onclick="setTitle('<?php echo $value; ?>');"></td>
                                                ...
                                                <td><input type="radio" value="time" name="<?php echo $value; ?>[]"
                                                        onclick="setTitle('<?php echo $value; ?>');"></td>
                                                ...
                                                <td><input type="radio" value="datetime" name="<?php echo $value; ?>[]"
                                                        onclick="setTitle('<?php echo $value; ?>');"></td>
        ...
        ?>
                                        ...
                                        <button type="button" name="<?php echo $value; ?>[]" value="multi_select"
                                            onclick="add_multi_table();" class="btn btn-info">
                                        ...
                                        <button type="button" name="<?php echo $value; ?>[]" value="single_select"
                                            onclick="get_table_dropdown();" class="btn btn-info">
                                        ...
                                        <input type="hidden" id="accet_url"
                                            value="<?php echo $this->config->item('accet_url'); ?>">

                                        <?php

    }

    public function get_one_many_fields()
    {
  ...
  <th>Date Time</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="top-display" id="table_id_<?php echo $i; ?>" style="display: none">
                                            ...
                                            Table: <select class="form-control" id="select_table_<?php echo $i; ?>"
                                                name="<?php echo $value . "[selected_table]"; ?>"
                                                onchange="show_key_value('select_table_<?php echo $i; ?>', 'table_key_id_<?php echo $i; ?>', 'table_value_id_<?php echo $i; ?>', '<?php echo $value; ?>', '<?php echo $i; ?>');">
            ...
            for ($j = 0; $j < count($tables); $j++) {
                ...
                if (!in_array($tables[$j], array())) {
                    ...
                    ?>
                                                ...
                                                <option value="<?php echo set_value('table_name', $tables[$j]); ?>">
                                                    <?php echo $tables[$j] ?></option>
                            ...
                            <table class="table multi_table_box" style="border-collapse: collapse;">
                                ...
                                <tr>
                                    ...
                                    <td colspan="4">
                                        <center>
                                            <h1>Many To Many<img
                                                    src="<?php echo base_url(); ?>accets/img/button-cross_basic_red.png"
                                                    onclick="delete_multi_table(this);" style="float: right;"></h1>
                                        </center>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="top-display">
                                            ...
                                            Multi Select Table: <a href="javascript:void(0);" data-toggle="popover"
                                                data-content="A second table that relate to current selected table. Eg: products and category."><i
                                                    class="fa fa-info-circle" aria-hidden="true"></i></a>

                                            <select class="form-control multi_table" name="multiselect[table][]"
                                                onchange="populate_key_val(this, 'multi_key', 'multi_value', '');">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="top-display multi_relation_table">
                                            ...
                                            <select class="form-control multi_relation_table"
                                                name="multiselect[r_table][]"
                                                onchange="popuplate_multi_get_key_value(this,'multi_relation_key','multi_relation_value','relation');">
    ...
    public function popuplate_multi_get_key_value()
    {
        ...
        ?>
                            ...
                            Key : <a href="javascript:void(0);" data-toggle="popover"
                                data-content="<?php echo $parent_table; ?> id"><i class="fa fa-info-circle"
        ...
        ?>
                            ...
                            Value : <a href="javascript:void(0);" data-toggle="popover"
                                data-content="<?php echo $multi_table; ?> id"><i class="fa fa-info-circle"
                                    aria-hidden="true"></i></a>
    ...
    public function r_get_key_value()
    {
    ...
    public function get_key_value()
    {
        ...
        ?>
                            ...
                            Key:<select class="form-control" id="key_<?php echo $id; ?>"
        ...
        ?>
                            ...
                            Value:<select class="form-control" id="value_<?php echo $id; ?>"
    ...
    public function get_table_dropdown()
    {
        ...
        ?>
                            ...
                            <div class="form-group">
                                ...
                                <span rowspan="2" valign="center"><img
                                        src="<?php echo base_url(); ?>/accets/img/button-cross_basic_red.png"
                                        onclick="delete_one_to_many(this);" style="float: right;"></span>
                                ...
                                <iframe id="myIframe" src="<?php echo base_url(); ?>admin/module/one_to_many_add"
    ...
    public function get_key_dropdown()
    {
        ...
        ?>
                            ...
                            <div class="col-sm-4">
                                ...
                                Select Field : <a href="javascript:void(0);" data-toggle="popover"
                                    data-content="<?php echo $parent_table; ?> id"><i class="fa fa-info-circle"
                                        aria-hidden="true"></i></a>

                                <select onchange="setRelatedField();" class="form-control" id="related_field"
                                    name="related_field">
