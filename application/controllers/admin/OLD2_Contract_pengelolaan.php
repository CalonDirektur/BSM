...
class Contract_pengelolaan extends CI_Controller
{
    ...
    public function add()
    {
        ...
        $this->form_validation->set_rules('jenis_pengelolaan', 'Jenis_pengelolaan Name', 'trim');
        $this->form_validation->set_rules('nomor_kontrak', 'Nomor_kontrak Name', 'required');
        $this->form_validation->set_rules('tgl_kontrak', 'Tgl_kontrak Name', 'trim');
        ...
        $this->form_validation->set_rules('durasi_kontrak_bulan', 'Durasi_kontrak_bulan Name', 'numeric');
