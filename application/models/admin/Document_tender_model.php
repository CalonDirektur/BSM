...
class Document_tender_model extends CI_Model
{
    public $v_fields=array('nama_document', 'link_document', 'tanggal_document', 'expire_date_doc', 'keterangan', 'tanggal_update');
