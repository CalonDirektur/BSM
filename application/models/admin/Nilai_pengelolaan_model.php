...
class Nilai_pengelolaan_model extends CI_Model
{
    public $v_fields = [
        'main_contract_recurring.nomor_kontrak',
    ...
    function getList($table, $pagination = [])
    {
        ...
        $this->db->select(
            "$table.*  , main_contract_recurring.nomor_kontrak as id_kontrak  , portofolio.jenis_portofolio as portofolio  , unit_fm_bm.nama_unit as fm "
        );
        ...
        $this->db->join(
            ...
            'nilai_pengelolaan.id_kontrak = main_contract_recurring.id_kontrak',
            'left'
        );
        $this->db->join(
            'portofolio',
            'nilai_pengelolaan.portofolio = portofolio.kode_portofolio',
            'left'
        );
        $this->db->join(
            'unit_fm_bm',
            'nilai_pengelolaan.fm = unit_fm_bm.nama_unit',
            'left'
        );
    ...
    function getRowdariContract($table, $id)
    {
        $this->db->select('*');
