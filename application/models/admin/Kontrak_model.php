...
{
    public $v_fields=array('nama_pengadaan', 'vendor', 'nilai_kontrak_customer', 'nilai_juskeb', 'nilai_kontrak_mitra', 'tanggal_kontrak_pengadaan', 'tanggal_kontrak_berakhir', 'tanggal_bast', 'tanggal_invoice', 'tanggal_payment', 'opex_capex.keterangan', 'lokasi', 'portofolio.jenis_portofolio', 'metode_pengadaan.keterangan_pengadaan', 'tanggal_penerimaan_juskeb', 'tanggal_pr', 'tanggal_po', 'tanggal_insert', 'users.username');
	...
	function getList($table, $pagination=array()) {
        ...
        $this->db->select("$table.*  , opex_capex.keterangan as opex_capex  , portofolio.jenis_portofolio as portofolio  , metode_pengadaan.keterangan_pengadaan as metode_pengadaan  , users.username as username ");
        $this->db->from($table);
         $this->db->join("opex_capex", "kontrak.opex_capex = opex_capex.keterangan", "left");  $this->db->join("portofolio", "kontrak.portofolio = portofolio.jenis_portofolio", "left");  $this->db->join("metode_pengadaan", "kontrak.metode_pengadaan = metode_pengadaan.keterangan_pengadaan", "left");  $this->db->join("users", "kontrak.username = users.id", "left");     
