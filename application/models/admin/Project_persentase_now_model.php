...
class Project_persentase_now_model extends CI_Model
{
    public $v_fields = [
        'project_contract.nomor_kontrak',
        'persentase_progress',
        'tanggal_update',
        'remark',
    ];
    ...
    function getList($table, $pagination = [])
    {
        ...
        $this->db->select(
            "$table.*  , project_contract.nomor_kontrak as id_kontrak "
        );
        ...
        $this->db->join(
            'project_contract',
            'project_persentase_now.id_kontrak = project_contract.id',
            'left'
        );
    ...
    function getRowfromContractProject($table, $id)
    {
        $this->db->select('*');
