             ...
             <!-- <div class="row">
                            <div class="col-12">
                                <div class="text-center filter-menu">
                                    ...
                                    <a href="javascript: void(0);" class="filter-menu-item" data-rel="Semangat">Semangat</a>
                                </div>
                            </div>
            </div> -->
            ...
            <div class="row filterable-content">
                <!-- <div class="col-12"> -->
                    <div class="card">
                        ...
                        <!-- <div class="row filter-item all photography illustrator "> -->
                            ...
                            <div class="row" id="simple-dragula" data-plugin="dragula">       
                               ...
                               <?php if (isset($results) and !empty($results)) {
                                ...
                                <div class="col-md-4 filter-item all <?php echo $value->kategori_1; ?> <?php echo $value->kategori_2; ?> <?php echo $value->kategori_3; ?> photography">
                                    ...
                                    <!-- <div class="card mb-0 mt-3 border border-success">     -->
                                        <div class="card-body">
                                            ...
                                            <p><?php echo substr ($anu , 0 , 250); ?> 
                                            <span
                                                class="badge badge-soft-secondary"> <a href="<?php echo base_url(); ?>insight/detail/<?php echo $value->id; ?>"> more </span>
