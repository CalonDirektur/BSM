            ...
            <div class="left-side-menu">
                ...
                <div class="h-100" data-simplebar>
                    ...
                    <div class="user-box text-center">
                        ...
                        <img src="https://cdn0.iconfinder.com/data/icons/set-ui-app-android/32/8-512.png" alt="user-img" title="Mat Helme"
                        <?php } else { ?>
                        
                        <img src="<?php echo base_url(); ?>assets/images/logo-telpro.png" alt="user-img" title="Mat Helme"
                        <?php } ?>
                        ...
                        <div class="dropdown">
                            <a href="javascript: void(0);" class="text-dark dropdown-toggle h5 mt-2 mb-1 d-block"
                                ...
                                <?php echo $pengguna->first_name; ?></a>
                                <?php } else {echo 'Welcome';} ?>
                                    
                            <!-- <div class="dropdown-menu user-pro-dropdown">

                                
                                <a href="javascript:void(0);" class="dropdown-item notify-item"> <i class="fe-user me-1"></i>
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul id="side-menu">
                            ...
                            <li>
                                ...
                                <a href="<?php echo base_url(); ?>insight/index" >
                        ...
                        <!-- <div class="p-3"> -->
                            ...
                            <!-- <h6 class="fw-medium font-14 mt-4 mb-2 pb-1">Kategori Insight</h6>
                        ...
                        <!-- </div> -->
                            ...
                            <li class="menu-title mt-2">Filter Hashtag #</li>
                            ...
                            <li class="text-white filter-menu " role="alert">

                            <div class="alert alert-warning">
                                <!-- <strong>Customize </strong> the overall color scheme, sidebar menu, etc. -->
                                 <a href="javascript: void(0);" class="filter-menu-item active" data-rel="all"> <i data-feather="box"></i><span>All</span></a>

                                    <?php if (
                                        isset($director_insight_category) and
                                    ...
                                    <a href="javascript: void(0);" class="filter-menu-item" data-rel="<?php echo $value->kategori_name; ?>">
                                    
                                    <i data-feather="filter"></i>
                                    <span><?php echo $value->kategori_name; ?></span></a>                                    
                                    <?php }
                                    } ?> 
                                    ...
                                    <a href="javascript: void(0);" class="filter-menu-item" data-rel="Semangat"><span>Semangat</span></a> -->
                                </div>
                            </li>
                            <?php } ?>
