            ...
            <center>
                <h1><b>
                        ...
                        function crossref(number) {
                            ...
                            var crossobj = document.all ? eval("document.all.neonlight" + number) : document
                ...
                <form action="" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Username"
                            value="<?php echo set_value('login'); ?>" name='login' id='login' required="">
