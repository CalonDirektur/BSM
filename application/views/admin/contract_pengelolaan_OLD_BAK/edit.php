...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    <textarea class="form-control" id="uraian_pekerjaan" name="uraian_pekerjaan"><?php echo set_value("uraian_pekerjaan",html_entity_decode($contract_pengelolaan->uraian_pekerjaan)); ?></textarea>
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    <textarea class="form-control" id="alamat_lokasi_kontrak" name="alamat_lokasi_kontrak"><?php echo set_value("alamat_lokasi_kontrak",html_entity_decode($contract_pengelolaan->alamat_lokasi_kontrak)); ?></textarea>
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("hrg_sc_per_periodkontrak_rp",html_entity_decode($contract_pengelolaan->hrg_sc_per_periodkontrak_rp)); ?>"
