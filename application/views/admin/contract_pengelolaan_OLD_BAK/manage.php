         ...
         <div class="table table-responsive">
            <table class="table table-striped table-bordered table-hover Tax" >
               <thead>
				...
				<?php $symbol = isset($_GET["sortBy"]) && $_GET["sortBy"]=="hrg_sc_per_periodkontrak_rp"?"<i class='fa fa-sort-$sortSym' aria-hidden='true'></i>": "<i class='fa fa-sort' aria-hidden='true'></i>"; ?>

				<th> <a href="<?php echo $fields_links["hrg_sc_per_periodkontrak_rp"]; ?>" class="link_css"> Hrg_sc_per_periodkontrak_rp <?php echo $symbol ?></a></th>
            ...
            <th><?php if(!empty($value->id)){ echo $count; $count++; }?></th><th><?php if(!empty($value->customer)){ echo $value->customer; }?></th>
                ...
                <th><?php if(!empty($value->hrg_sc_per_periodkontrak_rp)){ echo $value->hrg_sc_per_periodkontrak_rp; }?></th>
