  ...
  <div class="wrapper wrapper-content animated fadeInRight">
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    value="<?php echo set_value("wilayah"); ?>"
	...
	<!-- Wilayah End -->
			...
			<div class="form-group">
			  ...
			  <div class="col-sm-4">
			    ...
			    <textarea class="form-control" id="uraian_pekerjaan" name="uraian_pekerjaan"><?php echo set_value("uraian_pekerjaan"); ?></textarea>
	...
	<div class="form-group">
      ...
      foreach($jenis_pengelolaan as $key => $value): ?>
          ...
          <option value="<?php echo $value->pengelolaan; ?>">
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    <input type="text" class="form-control span2 datepicker" id="tgl_kontrak" name="tgl_kontrak" value="<?php echo set_value("tgl_kontrak","2022-01-25"); ?>"	    >
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    <input type="text" class="form-control span2 datepicker" id="masa_awal_kontrak" name="masa_awal_kontrak" value="<?php echo set_value("masa_awal_kontrak","2022-01-25"); ?>"	    >
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    <input type="text" class="form-control span2 datepicker" id="masa_akhir_kontrak" name="masa_akhir_kontrak" value="<?php echo set_value("masa_akhir_kontrak","2022-01-25"); ?>"	    >
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    value="<?php echo set_value("durasi_kontrak_bulan"); ?>"
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    value="<?php echo set_value("hrg_base_rent_m2"); ?>"
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    value="<?php echo set_value("hrg_srvc_chrg_m2"); ?>"
	...
	<!-- Hrg_srvc_chrg_m2 End -->
			...
			<div class="form-group">
			  ...
			  <div class="col-sm-4">
			    ...
			    <textarea class="form-control" id="alamat_lokasi_kontrak" name="alamat_lokasi_kontrak"><?php echo set_value("alamat_lokasi_kontrak"); ?></textarea>
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    value="<?php echo set_value("hrg_br_per_bulan_rp"); ?>"
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    value="<?php echo set_value("hrg_sc_per_bulan_rp"); ?>"
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    value="<?php echo set_value("hrg_br_per_periodkontrak_rp"); ?>"
	...
	<!-- Hrg_sc_per_periodkontrak_rp Start -->

	<div class="form-group">

	  <label for="hrg_sc_per_periodkontrak_rp" class="col-sm-3 control-label"> Hrg_sc_per_periodkontrak_rp </label>

	  <div class="col-sm-4">

	    <input type="text" class="form-control" id="hrg_sc_per_periodkontrak_rp" name="hrg_sc_per_periodkontrak_rp"



	    value="<?php echo set_value("hrg_sc_per_periodkontrak_rp"); ?>"
	  ...
	  <div class="col-sm-5" >
	    ...
	    <?php echo form_error("hrg_sc_per_periodkontrak_rp","<span class='label label-danger'>","</span>")?>

	  </div>

	</div>

	<!-- Hrg_sc_per_periodkontrak_rp End -->
	...
	<div class="form-group">
      ...
      foreach($satuan_period_kontrak as $key => $value): ?>
          ...
          <option value="<?php echo $value->satuan; ?>">
	...
	<div class="form-group">
      ...
      foreach($captive_or_non as $key => $value): ?>
          ...
          <option value="<?php echo $value->keterangan; ?>">
	...
	<div class="form-group">
      ...
      foreach($unit_fm_bm as $key => $value): ?>
          ...
          <option value="<?php echo $value->profit_center; ?>">
	...
	<div class="form-group">
      ...
      foreach($status_kontrak as $key => $value): ?>
          ...
          <option value="<?php echo $value->keterangan_status; ?>">
      ...
      <!-- Status_kontrak End -->
			...
			<div class="form-group">
			  ...
			  <div class="col-sm-4">
			    ...
			    <textarea class="form-control" id="tax_remark" name="tax_remark"><?php echo set_value("tax_remark"); ?></textarea>
    ...
    <div class="form-group">
      ...
      <input type="hidden" name="old_id_file" value="<?php if (isset($id_file) && $id_file!=""){echo $id_file; } ?>" />
