  ...
  <div class="wrapper wrapper-content animated fadeInRight">
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    value="<?php echo set_value("nama_pengadaan"); ?>"
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    value="<?php echo set_value("nilai_kontrak_customer"); ?>"
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    value="<?php echo set_value("nilai_juskeb"); ?>"
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    value="<?php echo set_value("nilai_kontrak_mitra"); ?>"
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    <input type="text" class="form-control span2 datepicker" id="tanggal_kontrak_pengadaan" name="tanggal_kontrak_pengadaan" value="<?php echo set_value("tanggal_kontrak_pengadaan","2022-01-11"); ?>"	    >
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    <input type="text" class="form-control span2 datepicker" id="tanggal_kontrak_berakhir" name="tanggal_kontrak_berakhir" value="<?php echo set_value("tanggal_kontrak_berakhir","2022-01-11"); ?>"	    >
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    <input type="text" class="form-control span2 datepicker" id="tanggal_bast" name="tanggal_bast" value="<?php echo set_value("tanggal_bast","2022-01-11"); ?>"	    >
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    <input type="text" class="form-control span2 datepicker" id="tanggal_invoice" name="tanggal_invoice" value="<?php echo set_value("tanggal_invoice","2022-01-11"); ?>"	    >
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    <input type="text" class="form-control span2 datepicker" id="tanggal_payment" name="tanggal_payment" value="<?php echo set_value("tanggal_payment","2022-01-11"); ?>"	    >
	...
	<div class="form-group">
      ...
      foreach($portofolio as $key => $value): ?>
          ...
          <option value="<?php echo $value->jenis_portofolio; ?>">
	...
	<div class="form-group">
      ...
      foreach($metode_pengadaan as $key => $value): ?>
          ...
          <option value="<?php echo $value->keterangan_pengadaan; ?>">
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    <input type="text" class="form-control span2 datepicker" id="tanggal_penerimaan_juskeb" name="tanggal_penerimaan_juskeb" value="<?php echo set_value("tanggal_penerimaan_juskeb","2022-01-11"); ?>"	    >
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    <input type="text" class="form-control span2 datepicker" id="tanggal_pr" name="tanggal_pr" value="<?php echo set_value("tanggal_pr","2022-01-11"); ?>"	    >
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    <input type="text" class="form-control span2 datepicker" id="tanggal_po" name="tanggal_po" value="<?php echo set_value("tanggal_po","2022-01-11"); ?>"	    >
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    <input type="text" class="form-control datetimepicker" id="tanggal_insert"  name="tanggal_insert"/>
