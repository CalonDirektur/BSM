  ...
  <div class="wrapper wrapper-content animated fadeInRight">
	...
	<div class="form-group">
      ...
      <?php if (isset($project_segmen) && !empty($project_segmen)):
          ...
          <option value="<?php echo $value->segment_customer; ?>">
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    value="<?php echo set_value('owner_group'); ?>"
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    value="<?php echo set_value('detil_projek'); ?>"
	...
	<div class="form-group">
      ...
      <?php if (
          ...
          <option value="<?php echo $value->handling; ?>">
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    value="<?php echo set_value('nilai_kontrak'); ?>"
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    value="<?php echo set_value('jangka_waktu_hari'); ?>"
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    <input type="text" class="form-control span2 datepicker" id="tanggal_mulai_kontrak" name="tanggal_mulai_kontrak" value="<?php echo set_value(
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    <input type="text" class="form-control span2 datepicker" id="tanggal_akhir_kontrak" name="tanggal_akhir_kontrak" value="<?php echo set_value(
	...
	<!-- <div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    value="<?php echo set_value('tahun_projek'); ?>"
	...
	<!-- <div class="form-group">
      ...
      <?php if (
          ...
          <option value="<?php echo $value->progress_opsi; ?>">
	...
	<!-- <div class="form-group">
	  ...
	  <label for="persentase_progress" class="col-sm-3 control-label"> Progress Awal Project Saat Ini (%) </label>
    ...
    <!-- <div class="form-group">
      ...
      <input type="hidden" name="old_dok_bapp" value="<?php if (
          isset($dok_bapp) &&
          $dok_bapp != ''
      ) {
          echo $dok_bapp;
    ...
    <!-- <div class="form-group">
      ...
      <input type="hidden" name="old_dok_baut" value="<?php if (
          isset($dok_baut) &&
          $dok_baut != ''
      ) {
          echo $dok_baut;
    ...
    <!-- <div class="form-group">
      ...
      <input type="hidden" name="old_dok_bast" value="<?php if (
          isset($dok_bast) &&
          $dok_bast != ''
      ) {
          echo $dok_bast;
