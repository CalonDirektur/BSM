   ...
   <div class="col-lg-12">
      <div class="ibox ">
         ...
         <div class="ibox-title">
            ...
            <?php endif; ?>
            <a href="<?php echo base_url(); ?>admin/opex_capex/add" class="btn btn-info">ADD NEW</a>
            <div class="form-group pull-right">
               <a href="<?php echo $csvlink; ?>" class="btn btn-info">CSV</a>
               <a href="<?php echo $pdflink; ?>" class="btn btn-info">PDF</a>
            </div>
            <form method="GET" action="<?php echo base_url().'admin/opex_capex/index'; ?>" class="form-inline ibox-content">
               <div class="form-group">
                  <select name="searchBy" class="form-control">
                  <option value="keterangan" <?php echo $searchBy=="keterangan"?'selected="selected"':""; ?>>Keterangan</option>
                  </select>
               </div>
               <div class="form-group">
         ...
         <div class="table table-responsive">
            <table class="table table-striped table-bordered table-hover Tax" >
               <thead>
				...
				<?php $symbol = isset($_GET["sortBy"]) && $_GET["sortBy"]=="keterangan"?"<i class='fa fa-sort-$sortSym' aria-hidden='true'></i>": "<i class='fa fa-sort' aria-hidden='true'></i>"; ?>

				<th> <a href="<?php echo $fields_links["keterangan"]; ?>" class="link_css"> Keterangan <?php echo $symbol ?></a></th>
            ...
            <th><?php if(!empty($value->id)){ echo $count; $count++; }?></th><th><?php if(!empty($value->keterangan)){ echo $value->keterangan; }?></th>

                <th class="action-width">

		   <a href="<?php echo base_url()?>admin/opex_capex/view/<?php echo $value->id; ?>" title="View">

            <span class="btn btn-info " ><i class="fa fa-eye"></i></span>

           </a>

           <a href="<?php echo base_url()?>admin/opex_capex/edit/<?php echo $value->id; ?>" title="Edit">

            <span class="btn btn-info " ><i class="fa fa-edit"></i></span>

           </a>

           <a  title="Delete" data-toggle="modal" data-target="#commonDelete" onclick="set_common_delete('<?php echo $value->id; ?>','opex_capex');">
...
<script type="text/javascript">
   ...
   $.ajax({
     type:"POST",
     url:'<?php echo base_url()."admin/opex_capex/deleteAll"; ?>',
     data:{
       allIds : ids,
