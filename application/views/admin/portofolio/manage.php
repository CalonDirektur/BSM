   ...
   <div class="col-lg-12">
      <div class="ibox ">
         ...
         <div class="ibox-title">
            ...
            <?php endif; ?>
            <a href="<?php echo base_url(); ?>admin/portofolio/add" class="btn btn-info">ADD NEW</a>
            <div class="form-group pull-right">
               <a href="<?php echo $csvlink; ?>" class="btn btn-info">CSV</a>
               <a href="<?php echo $pdflink; ?>" class="btn btn-info">PDF</a>
            </div>
            <form method="GET" action="<?php echo base_url().'admin/portofolio/index'; ?>" class="form-inline ibox-content">
               <div class="form-group">
                  <select name="searchBy" class="form-control">
                  <option value="jenis_portofolio" <?php echo $searchBy=="jenis_portofolio"?'selected="selected"':""; ?>>Jenis_portofolio</option>
                  </select>
               </div>
               <div class="form-group">
         ...
         <div class="table table-responsive">
            <table class="table table-striped table-bordered table-hover Tax" >
               <thead>
				...
				<?php $symbol = isset($_GET["sortBy"]) && $_GET["sortBy"]=="jenis_portofolio"?"<i class='fa fa-sort-$sortSym' aria-hidden='true'></i>": "<i class='fa fa-sort' aria-hidden='true'></i>"; ?>

				<th> <a href="<?php echo $fields_links["jenis_portofolio"]; ?>" class="link_css"> Jenis_portofolio <?php echo $symbol ?></a></th>
            ...
            <th><?php if(!empty($value->id)){ echo $count; $count++; }?></th><th><?php if(!empty($value->jenis_portofolio)){ echo $value->jenis_portofolio; }?></th>

                <th class="action-width">

		   <a href="<?php echo base_url()?>admin/portofolio/view/<?php echo $value->id; ?>" title="View">

            <span class="btn btn-info " ><i class="fa fa-eye"></i></span>

           </a>

           <a href="<?php echo base_url()?>admin/portofolio/edit/<?php echo $value->id; ?>" title="Edit">

            <span class="btn btn-info " ><i class="fa fa-edit"></i></span>

           </a>

           <a  title="Delete" data-toggle="modal" data-target="#commonDelete" onclick="set_common_delete('<?php echo $value->id; ?>','portofolio');">
...
<script type="text/javascript">
   ...
   $.ajax({
     type:"POST",
     url:'<?php echo base_url()."admin/portofolio/deleteAll"; ?>',
     data:{
       allIds : ids,
