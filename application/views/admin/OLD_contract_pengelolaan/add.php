...
<div class="row">
  <div class="wrapper wrapper-content animated fadeInRight">
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    value="<?php echo set_value("uraian_pekerjaan"); ?>"
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    value="<?php echo set_value("alamat_lokasi_kontrak"); ?>"
  ...
  <div class="form-group">
    ...
    <label for="hrg_sc_per_periodkontrakrp" class="col-sm-3 control-label"> hrg_sc_per_periodkontrakrp </label>
    ...
    <div class="col-sm-4">
      ...
      value="<?php echo set_value("hrg_sc_per_periodkontrakrp"); ?>"
