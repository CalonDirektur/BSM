...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("nama_document",html_entity_decode($document_tender->nama_document)); ?>"
  ...
  <div class="col-sm-5" >
    ...
    <?php echo form_error("nama_document","<span class='label label-danger'>","</span>")?>
...
<!-- Nama_document End -->
    ...
    <div class="form-group">
      ...
      value="<?php if (isset($link_document) && $link_document!=""){echo $link_document; }?>" />
        ...
        <?php if (isset($document_tender->link_document) && $document_tender->link_document!=""){?>

            <br>

  <img src="<?php echo $this->config->item("photo_url");?><?php echo $document_tender->link_document; ?>" alt="pic" width="50" height="50" />
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    <textarea class="form-control" id="keterangan" name="keterangan"><?php echo set_value("keterangan",html_entity_decode($document_tender->keterangan)); ?></textarea>
  ...
  <div class="col-sm-5" >
    ...
    <?php echo form_error("keterangan","<span class='label label-danger'>","</span>")?>
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("tanggal_update",$document_tender->tanggal_update); ?>"
