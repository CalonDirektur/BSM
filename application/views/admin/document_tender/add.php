  ...
  <div class="wrapper wrapper-content animated fadeInRight">
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    value="<?php echo set_value('nama_document'); ?>"
    ...
    <div class="form-group">
      ...
      <input type="hidden" name="old_link_document" value="<?php if (
          isset($link_document) &&
          $link_document != ''
      ) {
          echo $link_document;
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    <input type="text" class="form-control span2 datepicker" id="tanggal_document" name="tanggal_document" value="<?php echo set_value(
         'tanggal_document',
         '2022-03-10'
     ); ?>"	    >
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-4">
	    ...
	    <input type="text" class="form-control span2 datepicker" id="expire_date_doc" name="expire_date_doc" value="<?php echo set_value(
         'expire_date_doc',
         '2022-03-10'
     ); ?>"	    >
