  ...
  <div class="wrapper wrapper-content animated fadeInRight">
	...
	<div class="form-group">
      ...
      foreach($main_contract_recurring as $key => $value): ?>
          ...
          <option value="<?php echo $value->id_kontrak; ?>" <?php echo $value->id_kontrak==$nilai_pengelolaan->id_kontrak?'selected="selected"':""; ?>>
	...
	<div class="form-group">
      ...
      foreach($portofolio as $key => $value): ?>
          ...
          <option value="<?php echo $value->kode_portofolio; ?>" <?php echo $value->kode_portofolio==$nilai_pengelolaan->portofolio?'selected="selected"':""; ?>>
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("nilai_bulan",html_entity_decode($nilai_pengelolaan->nilai_bulan)); ?>"
...
<!-- Nilai_bulan End -->
	...
	<div class="form-group">
      ...
      foreach($unit_fm_bm as $key => $value): ?>
          ...
          <option value="<?php echo $value->nama_unit; ?>" <?php echo $value->nama_unit==$nilai_pengelolaan->fm?'selected="selected"':""; ?>>
