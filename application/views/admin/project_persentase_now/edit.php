  ...
  <div class="wrapper wrapper-content animated fadeInRight">
	...
	<div class="form-group">
      ...
      foreach($project_contract as $key => $value): ?>
          ...
          <option value="<?php echo $value->id; ?>" <?php echo $value->id==$project_persentase_now->id_kontrak?'selected="selected"':""; ?>>
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("persentase_progress",html_entity_decode($project_persentase_now->persentase_progress)); ?>"
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("tanggal_update",$project_persentase_now->tanggal_update); ?>"
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    <textarea class="form-control" id="remark" name="remark"><?php echo set_value("remark",html_entity_decode($project_persentase_now->remark)); ?></textarea>
