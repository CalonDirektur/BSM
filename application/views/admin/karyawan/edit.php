...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("nama",html_entity_decode($karyawan->nama)); ?>"
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("nik",html_entity_decode($karyawan->nik)); ?>"
...
<!-- Nik End -->
	...
	<div class="form-group">
      ...
      foreach($status_karyawan as $key => $value): ?>
          ...
          <option value="<?php echo $value->id; ?>" <?php echo $value->id==$karyawan->status?'selected="selected"':""; ?>>
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("unit",html_entity_decode($karyawan->unit)); ?>"
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("sub_unit",html_entity_decode($karyawan->sub_unit)); ?>"
...
<div class="form-group">
  ...
  <div class="col-sm-4">
    ...
    value="<?php echo set_value("jabatan",html_entity_decode($karyawan->jabatan)); ?>"
...
<!-- Jabatan End -->
	...
	<div class="form-group">
      ...
      foreach($users as $key => $value): ?>
          ...
          <option value="<?php echo $value->username; ?>" <?php echo $value->username==$karyawan->entry_by?'selected="selected"':""; ?>>
